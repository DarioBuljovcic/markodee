  ...
  return (
    <section id="about" className="w-full border-b border-foreground">
      <div className="grid grid-cols-1 md:grid-cols-2 min-h-[50vh]">
        {/* Left Column */}
        <div className="relative border-b md:border-b-0 md:border-r border-foreground p-6 md:p-12 lg:p-24 flex items-center justify-center md:items-start md:justify-start bg-background">
          <Image
            src="/Marko.png"
            alt="Markodee DJ"
            width={500}
        ...
        {/* Right Column */}
        <div className="p-6 md:p-12 lg:p-24 flex items-center bg-background">
